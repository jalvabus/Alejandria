...
<body ng-controller="compraController">
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse">
                <ul class="nav navbar-nav navbar-right">
                    <li class="active" ng-click="openCarrito()"><a href="#"> <i
    ...
    <div>
        <div class="container">
            ...
            <div class="row col-md-8">
                <ul class="list-group">
                    <li ng-repeat="libro in listlibros"
                        class="list-group-item d-flex justify-content-between align-items-center">
                        <div class="row">
                            <div class="col-md-10">
                                <h3>{{libro.nombre}}</h3>
                                <h5 class="text-muted">Editorial {{libro.editorial}}</h5>
                                <h5 class="text-muted">Autor - {{libro.autor.nombre}} {{libro.autor.apellido_paterno}}
                                    {{libro.autor.apellido_materno}}</h5>
                                <h5 class="text-muted">$ {{libro.costo}} MNM</h5>
                                <h5 ng-show="libro.stock == '0'"> Libro no disponible <h5>
                            </div>
                            <div class="col-md-2">
                                <button ng-show="libro.stock != '0'" class="btn btn-default btn-block btn-lg"
                                    ng-click="addLibroInCarrito(libro)"> <i class="fa fa-shopping-cart"></i></button>
                            </div>
                        </div>
                    </li>
                </ul>
    ...
    <!--MODAL CARRITO-->
    <!-- Modal -->
    <div class="modal fade" id="modal_carrito" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <ul ng-show="carrito.libros.length > 0" class="list-group">
                        <li ng-repeat="libro in carrito.libros"
                            class="list-group-item d-flex justify-content-between align-items-center">
                            {{libro.nombre}}
                        ...
                        <div class="container-fluid">
                            ...
                            <form>
                                <label class="radio-inline"><input type="radio" ng-model="pago.tipo"
                                        ng-click="showContainerTarjeta(false)" value="saldo" name="pago" checked>Saldo
                                    electronico</label>
                                <label class="radio-inline"><input type="radio" ng-model="pago.tipo"
                                        ng-click="showContainerTarjeta(true)" value="tarjeta" name="pago">Tarjeta
                            ...
                            <div class="container-fluid" id="container_tarjeta">
                                <div class="row">
                                    <div class="col">
                                        ...
                                        <input type="text" id="numero" maxlength="19" placeholder="XXXX-XXXX-XXXX-XXXX"
                                            class="form-control">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-6" style="padding-left: 0;">
                                        <label>CVV</label>
                                        <input type="text" id="cvv" maxlength="16" placeholder="XXX"
                                            class="form-control">
                                    </div>
                                    <div class="col-md-6" style="padding-right: 0;">
                                        <label>Vigencia</label>
                                        <input type="text" id="vigencia" maxlength="16" placeholder="AAAA-MM-DD"
                                            class="form-control">
                                    </div>
                                </div>
                            </div>
                        ...
                        -->
                            ...
                            <button ng-show="carrito.libros.length > 0" ng-click="comprar()" type="button"
                                class="btn btn-secondary btn-block" ng-click="comprar()">Comprar</button>
                        </div>

                    </ul>
                </div>
                <div class="modal-footer">
                    <button ng-show="carrito.libros.length > 0" class="btn btn-secondary" ng-click="dropCarrito()">
                        Vaciar </button>
