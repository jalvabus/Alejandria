...
<body ng-controller="wishListController">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12 col-md-6 col-lg-6">
                        <div class="blog-post-title">
                            <h3>
                                Mi Wish List
                                <button class="btn" data-toggle="modal" data-target="#modal_share"> <i
                                        class="fa fa-share"></i>
                                </button>
                            </h3>
                            <button class="btn btn-block"> Invitar Personas </button>
                        </div>
                                    ...
                                    <div class="col-xs-6 row">
                                        <div class="col-md-4">
                                            <button class="btn btn-default btn-block btn-lg" data-toggle="modal"
                                                ...
                                                ng-click="comprarLibro(libros.libro, wishlist)">
                                                <i class="fa fa-shopping-cart"></i>
                                            </button>
                                        </div>
                                        <div class="col-md-4">
                                            <button class="btn btn-default btn-block btn-lg"
                                                ng-click="removeToWishList(libros.libro)"><i class="fa fa-trash"></i>
                                            </button>
                                        </div>
                                        <div class="col-md-4">
                                            <div ng-if="!libros.favorito">
                                                <button ng-click="updateFavsWishlist(libros.libro, true)"
                                                    class="btn btn-default btn-block btn-lg">
                                                    <i class="fa fa-heart"></i>
                                                </button>
                                            </div>
                                            <div ng-if="libros.favorito">
                                                <button ng-click="updateFavsWishlist(libros.libro, false)"
                                                    class="border-red btn btn-default btn-block btn-lg">
                    ...
                    <div class="col-sm-12 col-md-6 col-lg-6">
                        <div class="blog-post-title">
                            ...
                            <div>
                                <input type="text" class="form-control" ng-keyup="bucarWish()" ng-model="buscador"
                                    placeholder="Ingresa nombre de wishlist para buscar">
                            </div>
                            <br>
                        </div>
                        <div class="panel panel-default">
                            ...
                            <ul class="list-group list-group-item" ng-repeat="shared in sharedwishlist">
                                <div class="row">
                                    ...
                                    <div class="col-xs-3">
                                        <button class="btn btn-default btn-block btn-lg" data-toggle="modal"
                                            data-target="#modal_sharedwishlist" ng-click="thisWish(shared)">
                                            <i class="fa fa-eye"></i>
                                        </button>
                                    </div>
                                </div>
                        ...
                        <div class="single-team-member">
                            ...
                            <div class="team-content text-center">
                                ...
                                <button class="btn btn-secondary btn-sm btn-block"
                                    ng-click="addToWishlist(libro.id_libro)">Añadir
                                    a mi lista </button>
                                <button class="btn btn-secondary btn-sm btn-block" ng-click="seeBook(libro)"
                                    data-toggle="modal" data-target="#modalDetails">Detalles
                                    del libro</button>
                            </div>
                        </div>
                    </div>
    ...
    <!-- Modal Invitar Wish List -->
    <div class="modal fade" id="modal_share" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div clas="form-group">
                        <p>Ingresa el correo electronico de las persona a quien quieras invitar a tu lista de deseos
                        </p>
                        <p>Nota: Si la persona no esta registrada no podra ver tu lista de deseos</p>
                        <h5 class="modal-title" id="exampleModalLabel">Correo no 1</h5>
                        <input type="text" placeholder="Correo@gmail.com" class="form-control" ng-model="shareW.correo1">
                        <h5 class="modal-title" id="exampleModalLabel">Correo no 2</h5>
                        <input type="text" placeholder="Correo@gmail.com" class="form-control" ng-model="shareW.correo2">
                        <h5 class="modal-title" id="exampleModalLabel">Correo no 3</h5>
                        <input type="text" placeholder="Correo@gmail.com" class="form-control" ng-model="shareW.correo3">
                        <h5 class="modal-title" id="exampleModalLabel">Correo no 4</h5>
                        <input type="text" placeholder="Correo@gmail.com" class="form-control" ng-model="shareW.correo4">
                        <h5 class="modal-title" id="exampleModalLabel">Correo no 5</h5>
                        <input type="text" placeholder="Correo@gmail.com" class="form-control" ng-model="shareW.correo5">
                    </div>
                    <button class="btn btn-secondary btn-block" ng-click="shareWishlistMasivo()">Compartir</button>
    ...
    <!-- Modal Compra Libro -->
    <div class="modal fade" id="modal_detallesCompra" tabindex="-1" role="dialog"
        aria-labelledby="exampleModalCenterTitle" aria-hidden="true" aria-hidden="true" style="text-align: center;">
        <div class="modal-dialog modal-dialog-centered" role="document"
            style="display: inline-block; vertical-align: middle; text-align: left; height: 100%;">
            <div class="modal-content">
                <div class="modal-header">
                    <h3 class="modal-title" id="exampleModalCenterTitle">Detalles de la compra</h3>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <div style="margin-top: 20px;">
                        <div>
                            <p>
                                <strong>Libro Comprado de la wish list del usuario:
                                    {{ detalles_compra.wishlist.usuario.usuario }}</strong>
                                <strong> Con nombre: {{ detalles_compra.wishlist.usuario.persona.nombre }}
                                    {{ detalles_compra.wishlist.usuario.persona.apellido_paterno }}</strong>
                            </p>
    ...
    <div class="modal fade" id="modalCompra" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
        aria-hidden="true" aria-hidden="true" style="text-align: center;">
        <div class="modal-dialog modal-dialog-centered" role="document"
            style="display: inline-block; vertical-align: middle; text-align: left; height: 100%;">
            <div class="modal-content">
                <div class="modal-header">
                        ...
                        <div>
                            ...
                            <form class="contactForm">
                                        ...
                                        <div class="row">
                                            <div class="col-xs-6">
                                                <input type="number" class="form-control"
                                                    ng-model="tarjeta_prepago.numero" id="saldoTarjeta"
                                                    placeholder="Numero de tarjeta">

                                            </div>
                                            <div class="col-xs-6">
                                                <button class="btn btn-block"
                                                    ng-click="getDatosTarjeta()">Verificar</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group" style="margin-top: 20px;" ng-if="tipopago == 'puntos'">
                                    ...
                                    <label>Numero de tarjeta de {{tipopago}}</label>
                                    <input type="number" class="form-control" ng-model="tarjeta_prepago.numero"
                                        id="saldoTarjeta" placeholder="Numero de tarjeta">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary" data-dismiss="modal" aria-label="Close"
                        ng-if="verificacionTarjeta === true" ng-click="compraLibro(libro)">Comprar
                        Libro
                    </button>
                </div>
            </div>
    ...
    <!-- Modal Detalles WishList Compartida -->
    <div class="modal fade" id="modal_sharedwishlist" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group row">
                        <div class="col-xs-9">
                            <input type="text" class="form-control" placeholder="Alias de la wishlist"
                                ng-model="aliasSharedWishlist">
                        </div>
                        <div class="col-xs-3"><button class="btn btn-block"
                                ng-click="updtaeAliasSharedWishlist(sharedwishlistbyusuario.id_compartir)"
                        ...
                        <a class="list-group-item">
                            <div class="row">
                                ...
                                <div class="col-xs-4 row">
                                    <button class="btn btn-default btn-block btn-lg" data-dismiss="modal"
                                        data-toggle="modal" data-target="#modalCompra"
                                        ng-click="comprarLibro(objectlibro.libro, sharedwishlistbyusuario.wishlist)">
                                        <i class="fa fa-shopping-cart"></i>
                                    </button>
                                </div>
                            </div>
    ...
    <div class="modal fade" id="modalDetails" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
        aria-hidden="true" aria-hidden="true" style="text-align: center; padding-top: 10%;">
        <div class="modal-dialog modal-dialog-centered" role="document"
            style="display: inline-block; vertical-align: middle; text-align: left; height: 100%;">
            <div class="modal-content">
                <div class="modal-header">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12 text-left">
                                <div class="well-middle">
                                    <div class="single-well">
                                        <strong>
                                            <p>Nombre del libro: {{libro.nombre}}</p>
                                        </strong>
                                        <strong>
                                            <p>Autores del libro: {{libro.autor.nombre}}</p>
                                        </strong>
                                        <strong>
                                            <p>Editorial del libro: {{libro.editorial}}</p>
                                        </strong>
                                        <strong>
                                            <p>Precio del libro: {{libro.costo}}</p>
                                        </strong>
                                        <strong>
                                            <p>Categoria del libro: {{libro.categoria}}</p>
                                        </strong>
                                        <strong>
                                            <p>Descripcion del libro: {{libro.descripcion}}</p>
                                        </strong>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary" data-dismiss="modal"
                        ng-if="verificacionTarjeta === true" ng-click="comprarLibro('comprar', null)">Comprar
                        Libro
                    </button>
                </div>
            </div>
